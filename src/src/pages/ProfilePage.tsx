...
const ProfilePage = () => {
  ...
  const [savedJobsList, setSavedJobsList] = useState<JobType[]>([]);
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{savedJobsList.length}</span>
                      </div>
                      <div className="flex justify-between">
          ...
          <TabsContent value="saved" className="mt-6">
            <Card>
              ...
              <CardContent>
                {isLoadingSaved ? (
                  <div className="text-center py-6">
                    <p className="text-gray-500">Cargando propuestas guardadas...</p>
                  </div>
